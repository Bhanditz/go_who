...
func (a *App) initializeRoutes() {
	...
	a.Router.HandleFunc("/code/google", a.codeGoogle).Methods("GET")
	a.Router.HandleFunc("/code/google", a.codeGoogle).Methods("POST")
...
func (a *App) codeGoogle(w http.ResponseWriter, r *http.Request) {
